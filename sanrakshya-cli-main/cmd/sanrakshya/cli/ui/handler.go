...
import (
	...
	sanrakshyaEvent "github.com/anubhav06/sanrakshya-cli/sanrakshya/event"
)
...
func New(cfg HandlerConfig) *Handler {
	...
	d.AddHandlers(map[partybus.EventType]bubbly.EventHandlerFn{
		...
		sanrakshyaEvent.FileIndexingStarted:  simpleHandler(h.handleFileIndexingStarted),
		sanrakshyaEvent.AttestationStarted:   simpleHandler(h.handleAttestationStarted),
		sanrakshyaEvent.CatalogerTaskStarted: h.handleCatalogerTaskStarted,
	})
