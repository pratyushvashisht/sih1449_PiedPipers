...
func (cfg *registry) PostLoad() error {
	...
	authority, username, password, token, tlsCert, tlsKey :=
		os.Getenv("sanrakshya_REGISTRY_AUTH_AUTHORITY"),
		os.Getenv("sanrakshya_REGISTRY_AUTH_USERNAME"),
		os.Getenv("sanrakshya_REGISTRY_AUTH_PASSWORD"),
		os.Getenv("sanrakshya_REGISTRY_AUTH_TOKEN"),
		os.Getenv("sanrakshya_REGISTRY_AUTH_TLS_CERT"),
		os.Getenv("sanrakshya_REGISTRY_AUTH_TLS_KEY")
