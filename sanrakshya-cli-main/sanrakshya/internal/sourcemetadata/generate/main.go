...
// This program is invoked from sanrakshya/internal and generates sourcemetadata/generated.go

const (
	srcImport = "github.com/anubhav06/sanrakshya-cli/sanrakshya/source"
...
func main() {
	...
	f.HeaderComment("DO NOT EDIT: generated by sanrakshya/internal/sourcemetadata/generate/main.go")
	f.ImportName(srcImport, "source")
	f.Comment("AllTypes returns a list of all source metadata types that sanrakshya supports (that are represented in the source.Description.Metadata field).")
