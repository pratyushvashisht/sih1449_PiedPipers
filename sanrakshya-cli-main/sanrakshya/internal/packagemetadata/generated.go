// DO NOT EDIT: generated by sanrakshya/internal/packagemetadata/generate/main.go

package packagemetadata

import "github.com/anubhav06/sanrakshya-cli/sanrakshya/pkg"

// AllTypes returns a list of all pkg metadata types that sanrakshya supports (that are represented in the pkg.Package.Metadata field).
func AllTypes() []any {
	return []any{
		pkg.AlpmDBEntry{},
		pkg.ApkDBEntry{},
