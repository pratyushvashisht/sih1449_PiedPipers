/*
Package sanrakshya is a "one-stop-shop" for helper utilities for all major functionality provided by child packages of the sanrakshya library.

Here is what the main execution path for sanrakshya does:
...
// SetLogger sets the logger object used for all sanrakshya logging calls.
func SetLogger(logger logger.Logger) {
	log.Set(logger)
}

// SetBus sets the event bus for all sanrakshya library bus publish events onto (in-library subscriptions are not allowed).
