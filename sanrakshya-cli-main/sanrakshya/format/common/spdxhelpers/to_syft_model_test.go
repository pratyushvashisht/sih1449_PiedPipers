...
func TestTosanrakshyaModel(t *testing.T) {
	sbom, err := TosanrakshyaModel(&spdx.Document{
		SPDXVersion:                "1",
		DataLicense:                "GPL",
...
func TestExtractSourceFromNamespaces(t *testing.T) {
	tests := []struct {
		...
		{
			namespace: "https://anchore.com/sanrakshya/file/d42b01d0-7325-409b-b03f-74082935c4d3",
			expected:  source.FileSourceMetadata{},
		},
		{
			namespace: "https://anchore.com/sanrakshya/image/d42b01d0-7325-409b-b03f-74082935c4d3",
			expected:  source.StereoscopeImageSourceMetadata{},
		},
		{
			namespace: "https://anchore.com/sanrakshya/dir/d42b01d0-7325-409b-b03f-74082935c4d3",
...
func TestH1Digest(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			p := tosanrakshyaPackage(&test.pkg)
...
func Test_tosanrakshyaRelationships(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := tosanrakshyaRelationships(tt.args.spdxIDMap, tt.args.doc)
