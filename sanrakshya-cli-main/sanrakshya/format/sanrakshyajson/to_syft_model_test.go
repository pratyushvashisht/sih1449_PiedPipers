...
func Test_tosanrakshyaSourceData(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			actual := tosanrakshyaSourceData(test.src)
...
func Test_idsHaveChanged(t *testing.T) {
	s := tosanrakshyaModel(model.Document{
		Source: model.Source{
			Type:     "file",
...
func Test_tosanrakshyaFiles(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, tt.want, tosanrakshyaFiles(tt.files))
		})
	}
}
...
func Test_toSyfRelationship(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, gotErr := tosanrakshyaRelationship(tt.idMap, tt.relationships, tt.idAliases)
