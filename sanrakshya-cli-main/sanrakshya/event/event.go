/*
Package event provides event types for all events that the sanrakshya library published onto the event bus. By convention, for each event
...
const (
	typePrefix    = "sanrakshya"
	cliTypePrefix = typePrefix + "-cli"

	// Events from the sanrakshya library
